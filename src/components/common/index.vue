      ...
      <Header>
        <Menu mode="horizontal" theme="dark" active-name="1" @on-select="routeTo">
          ...
          <div class="layout-nav" >
            <MenuItem name="index" class="logo" >
              <Icon type="ios-navigate" ></Icon>
              源图
            </MenuItem>
            <MenuItem name="userinfo" class="right" >
              <Icon type="ios-contact" />
              用户
            </MenuItem>
            <MenuItem name="thumbs" class="right">
            ...
            <!--Item 3-->
            <!--</MenuItem>-->
            <MenuItem name="notification" class="right">
              <Badge :count="3">
                <a href="#" class="demo-badge"></a>
              </Badge>
            </MenuItem>
            <MenuItem name="submit" class="right" >
        ...
        <Sider collapsible :collapsed-width="78" v-model="isCollapsed">
          <Menu active-name="" theme="dark" width="auto" :class="menuitemClasses" @on-select="routeTo">
            ...
            <Submenu name="2" >
              ...
              <MenuItem name="project">我的项目</MenuItem>
              <MenuItem name="analyse">项目分析</MenuItem>
              <!--<MenuItem name="favorite">我的收藏</MenuItem>-->
              <!--<MenuItem name="endproject">归档项目</MenuItem>-->
              <MenuItem name="organization">我的组织</MenuItem>
            ...
            <Menu-item name="daily">
              ...
              <span class="layout-text">周日报</span>
            </Menu-item>
            <Menu-item name="test">
              <Icon type="pie-graph" :size="iconSize"></Icon>
            ...
            <div class="custom-bread-crumb">
              <!--<Breadcrumb :style="{fontSize: `${fontSize}px`}">-->
                <!--<BreadcrumbItem v-for="item in list" :to="item.to" :key="`bread-crumb-${item.name}`">-->
                  <!--&lt;!&ndash;<common-icon style="margin-right: 4px;" :type="item.icon || ''"/>&ndash;&gt;-->
                  <!--{{ showTitle(item) }}-->
                <!--</BreadcrumbItem>-->
              <!--</Breadcrumb>-->

              <Breadcrumb :style="{fontSize: `${fontSize}px`}" separator="<b class='demo-breadcrumb-separator'>=></b>" >
